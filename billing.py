...
root.title(" Shah Food Billing System ")
...
def CostofItem():
    ...
    PriceofDrinks =(Item1 * 20) + (Item2 * 25) + (Item3 * 30) + (Item4 * 50) + (Item5 * 60) + (Item6 * 20) + \
                   (Item7 * 30) + (Item8 * 50)

    PriceofFood = (Item9 * 60) + (Item10 * 35) + (Item11 * 40) + (Item12 * 50) + (Item13 * 20) + (Item14 * 40) + \
                  (Item15 * 50) + (Item16 * 50)
